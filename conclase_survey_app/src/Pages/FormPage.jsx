        ...
        <div className="question">
          <div className="formframe-3">
            ...
            <div className="div-frame">
              ...
              <span className="span-option-1">Option 1</span>
            </div>
            <div className="div-frame-6">
              <div className="div-group" />
              <span className="span-option-2">Option 2</span>
            </div>
            <div className="div-frame-7">
              <div className="div-ellipse-8" />
              <span className="span-option-3">Option 3</span>
            </div>
            <div className="div-frame-9">
              <div className="div-ellipse-a" />
              <span className="span-option-4">Option 4</span>
            </div>
          </div>
        </div>
